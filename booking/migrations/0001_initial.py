# Generated by Django 4.0.2 on 2022-04-17 17:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default=None, upload_to='app_user/%Y/%m')),
                ('created_date', models.DateField(auto_now_add=True)),
                ('upp_date', models.DateField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('starting_date', models.DateTimeField(default=True)),
                ('ending_date', models.DateTimeField(default=True)),
                ('note', models.TextField(max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('point', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='point_booking', to='booking.routes')),
                ('price', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='price_booking', to='booking.tickets')),
            ],
        ),
        migrations.AddField(
            model_name='user',
